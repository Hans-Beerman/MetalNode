...
ACNode::ACNode(const char * m, const char * dev1, const char * dev2, bool wired, acnode_proto_t proto) : 
...
ACNode::ACNode(const char *m, const char * dev1, const char * dev2, const char * ssid , const char * ssid_passwd, acnode_proto_t proto ) :
...
void ACNode::request_approval_devices(const char * tag) {
    if (device1 != NULL) {
        request_approval(tag, NULL, device1);
    }
    if (device2 != NULL) {
        request_approval(tag, NULL, device2);
    }
    if ((device1 == NULL) && (device2 == NULL)) {
        request_approval(tag);
    }
} 
