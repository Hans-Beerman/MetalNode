...
public:
    ACNode(const char * machine = NULL, const char * device1 = NULL, const char * device2 = NULL, bool wired = true, acnode_proto_t proto = PROTO_SIG2);
    ACNode(const char * machine, const char * device1, const char * device2, const char * ssid, const char * ssid_passwd, acnode_proto_t proto = PROTO_SIG2);
    ...
    void request_approval_devices(const char * tag);
